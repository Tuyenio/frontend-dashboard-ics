      ...
      <div className="absolute top-6 left-6 right-6 flex justify-between items-center z-20">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-2 rounded-lg bg-white/80 light:bg-white light:shadow-md dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 hover:bg-white dark:hover:bg-slate-700 transition-all"
